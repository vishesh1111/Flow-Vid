    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f0f0f] px-4">
      <div className="w-full max-w-[448px]">
        ...
        <div className="text-center mb-10">
          <svg className="w-[90px] h-5 inline-block mb-10" viewBox="0 0 90 20" fill="none">
            <g>
        ...
        {/* Register Form - YouTube Style */}
        <div className="border border-[#303030] rounded-lg p-10 bg-[#181818]">
          {error && (
            <div className="mb-6 p-4 bg-[#ff0000]/10 border border-[#ff0000] rounded text-[#ff0000] text-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <input
                ...
                required
                className="w-full bg-transparent border-b border-[#909090] px-0 py-3 text-base text-white placeholder-[#888] focus:border-[#3ea6ff] focus:outline-none transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#3ea6ff] hover:bg-[#2a8fdd] disabled:bg-[#263850] text-white font-medium py-2.5 rounded-sm transition-colors disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-8 text-center text-sm">
            <span className="text-[#aaa]">Already have an account? </span>
